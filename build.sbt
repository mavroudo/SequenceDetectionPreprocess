...
libraryDependencies += "com.github.scopt" %% "scopt" % "4.0.0" //parser for the commandlines
...
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-core" % "3.2.3"
libraryDependencies += "org.apache.hadoop" % "hadoop-common" % "3.2.3"
libraryDependencies += "org.apache.hadoop" % "hadoop-client" % "3.2.3"
libraryDependencies += "org.apache.hadoop" % "hadoop-aws" % "3.2.3" //3.0.3
