...
/**
 * This class defines and implements extensions to the 
 * basic log meta-model. 
 * 
 * Extensions have a name, a defined prefix, and a unique
 * URI. They can define additional, typed attributes on 
 * the level of the log, trace, and event. Also,
 * extensions may define meta attributes, i.e. attributes
 * which describe other, higher-level attributes.
 * 
...
public class XExtension {
	...
	/**
	 * Unique URI of the extension. This URI should point to
	...
	protected URI uri;
	/**
	 * Set containing all attributes defined by this extension,
	 * on all possible levels of abstraction.
	 */
	protected HashSet<XAttribute> allAttributes;
	/**
	 * Set containing all attributes defined by this extension
	 * on the level of logs.
	 */
	...
	/**
	 * Set containing all meta-attributes defined by this extension,
	 * i.e. on the level of attributes.
	 */
	 ...
	 * @param prefix Prefix string to be used for this extension.
	 * @param uri Unique URI used for identifying this extension. 
	 ...
	 * This prefix should be no longer than 5 characters, so as
	 * not to unnecessarily blow up storage files.
	 */
	...
	/**
	 * Returns the collection of attributes defined by this
	 * extension for any log elements (archive-, log-, trace-,
	 * event-, and meta-attributes).
	 */
	...
	/**
	 * Returns the collection of meta-attributes defined by this
