...
/**
 * Helper class. This class can be used to dynamically wrap
 * any event, and provides an extended set of getter and
 * setter methods for typically-available extension attributes.
 * 
...
public class XExtendedEvent implements XEvent {
	...
	/**
	 * Static wrapper method. Wraps the given event into
	 * an instance of this class, which transparently
	 * provides extended access to attributes.
	 * 
	 ...
	 * 
	 * @param original The original event to be wrapped.
	 */
	...
	/**
	 * Retrieves the activity name of this event, as defined by
	...
	/**
	 * Sets the activity name of this event, as defined by the
	 * Concept extension.
	 * 
	 * @param name Activity name of the event.
	 */
	...
	/**
	 * Retrieves the activity instance of this event, as defined by
	 * the Concept extension.
	 * 
	...
	/**
	 * Sets the activity instance of this event, as defined by the
	 * Concept extension.
	 * 
	...
	/**
	 * Retrieves the timestamp of the event, as defined by
	 * the Time extension.
	 * 
	 * @return Timestamp as Date object, or <code>null</code>
	 * if not defined.
	 */
	...
	/**
	 * Sets the timestamp of the event, as defined by the Time
	 * extension.
	 * 
	 * @param timestamp Timestamp, as Date, to be set.
	 */
	 ...
	 * extension.
	 * 
	 * @param timestamp Timestamp, as long value in milliseconds, to be set.
	 */
	...
	/**
	 * Returns the resource of the event, as defined by the
	...
	/**
	 * Sets the resource of the event, as defined by the 
	 * Organizational extension.
	 * 
	 * @param resource Resource string.
	 */
	public void setResource(String resource) {
		XOrganizationalExtension.instance().assignResource(original, resource.trim());
	}
	
	/**
	 * Returns the role of the event, as defined by the
	 * Organizational extension.
	 * 
	...
	/**
	 * Sets the role of the event, as defined by the 
	 * Organizational extension.
	 * 
	...
	/**
	 * Returns the group of the event, as defined by the
	 * Organizational extension.
	 * 
	...
	/**
	 * Sets the group of the event, as defined by the 
	 * Organizational extension.
	 * 
	...
	/**
	 * Returns the lifecycle transition of the event, as
	 * defined by the Lifecycle extension.
	 * 
	 * @return Lifecycle transition string. 
	 * Can be <code>null</code>, if not defined.
	 */
	...
	/**
	 * Sets the lifecycle transition of the event, as
	 * defined by the Lifecycle extension.
	 * 
	...
	/**
	 * Returns the standard lifecycle transition of the event, as
	 * defined by the Lifecycle extension.
	 * 
	 * @return Standard lifecycle transition object. 
	 * Can be <code>null</code>, if not defined.
	 */
	public XLifecycleExtension.StandardModel getStandardTransition() {
		return XLifecycleExtension.instance().extractStandardTransition(original);
	}
	
	/**
	 * Sets the standard lifecycle transition of the event, as
	 * defined by the Lifecycle extension.
	 * 
	 * @param transition Standard lifecycle transition object.
	 */
	public void setStandardTransition(XLifecycleExtension.StandardModel transition) {
		XLifecycleExtension.instance().assignStandardTransition(original, transition);
	}
	
	/**
	 * Returns the list of model references defined for this event,
	 ...
	 * as defined in the Semantic extension.
	 * 
	 * @param modelReferences List of model reference strings.
	 */
	public void setModelReferences(List<String> modelReferences) {
		XSemanticExtension.instance().assignModelReferences(original, modelReferences);
	}
	...
	public List<URI> getModelReferenceURIs() {
		return XSemanticExtension.instance().extractModelReferenceURIs(original);
	}
	
	/**
	 * Sets the list of model reference URIs defined for this event,
	 * as defined in the Semantic extension.
	 * 
	 * @param modelReferenceURIs List of model reference URIs.
	 */
	public void setModelReferenceURIs(List<URI> modelReferenceURIs) {
		XSemanticExtension.instance().assignModelReferenceUris(original, modelReferenceURIs);
	}
	...
	/* (non-Javadoc)
	 * @see org.deckfour.xes.model.XAttributable#setAttributes(org.deckfour.xes.model.XAttributeMap)
	 */
