...
/**
 * This extension adds the organizational perspective to
 * event logs.
 * 
...
public class XOrganizationalExtension extends XExtension {
	 ...
	 */
	public static final URI EXTENSION_URI = URI.create("http://code.deckfour.org/xes/org.xesext");
	/**
	...
	private XOrganizationalExtension() {
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_RESOURCE, "Resource");
		XGlobalAttributeNameMap.instance().registerMapping(
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_RESOURCE, "Recurso");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_ROLE, "Papel");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_GROUP, "Grupo");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_RESOURCE, "Recurso");
		XGlobalAttributeNameMap.instance().registerMapping(
	 ...
	 * @return Resource string for the given event (may be <code>null</code> if not defined)
	 */
	 ...
	 * @param resource Resource string to be assigned.
	 */
	 ...
	 * 
	 * @param event Event to be queried.
	 * @return Role string for the given event (may be <code>null</code> if not defined)
	 */
	 ...
	 * 
	 * @param event Event to be modified.
	 * @param resource Role string to be assigned.
	 */
	 ...
	 * 
	 * @param event Event to be queried.
	 * @return Group string for the given event (may be <code>null</code> if not defined)
	 */
	 ...
	 * 
	 * @param event Event to be modified.
	 * @param resource Group string to be assigned.
	 */
