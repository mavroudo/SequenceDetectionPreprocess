 ...
 * 
 * Lifecycles define a set of states for activities, with an accompanying
 * set of transitions between those states. Any event which is referring to
 * by a lifecycle represents a certain transition of an activity within that
 * lifecycle.
 * 
...
public class XLifecycleExtension extends XExtension {
	...
	public enum StandardModel {
		 ...
		 * @param encoding Encoding of transition.
		 */
		...
		/**
		 * Decodes any encoding string, referring to the
		 * respective standard-model lifecycle transition
		 * object in this enum.
		 * 
	 ...
	 */
	public static final URI EXTENSION_URI = URI.create("http://code.deckfour.org/xes/lifecycle.xesext");
	/**
	...
	private XLifecycleExtension() {
		...
		ATTR_MODEL = 
			factory.createAttributeLiteral(KEY_MODEL, VALUE_MODEL_STANDARD, this);
		ATTR_TRANSITION = 
			factory.createAttributeLiteral(KEY_TRANSITION, StandardModel.COMPLETE.getEncoding(), this);
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_MODEL, "Lifecycle Model");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_TRANSITION, "Lifecycle Transition");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_MODEL, "Lebenszyklus-Model");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_TRANSITION, "Lebenszyklus-Transition");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_MODEL, "Modèle du Cycle Vital");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_TRANSITION, "Transition en Cycle Vital");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_MODEL, "Modelo de Ciclo de Vida");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_TRANSITION, "Transición en Ciclo de Vida");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_MODEL, "Modelo do Ciclo de Vida");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_TRANSITION, "Transição do Ciclo de Vida");
	}
	 ...
	 * @return The lifecycle transition string of this event.
	 ...
	 * 
	 * @param event An event.
	 * @return The standard lifecycle transition instance of this event.
	 * Can be <code>null</code>, if not defined.
	 */
