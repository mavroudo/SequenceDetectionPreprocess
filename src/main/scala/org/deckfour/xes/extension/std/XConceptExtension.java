...
/**
 * This extension provides naming for concepts in
 * the event log type hierarchy.
 * 
...
public class XConceptExtension extends XExtension {
	 ...
	 */
	public static final URI EXTENSION_URI = URI.create("http://code.deckfour.org/xes/concept.xesext");
	/**
	 ...
	 */
	private static XConceptExtension singleton = new XConceptExtension();
	...
	private XConceptExtension() {
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_INSTANCE, "Instance");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_NAME, "Name");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_INSTANCE, "Instanz");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_NAME, "Appellation");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_INSTANCE, "Entité");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_NAME, "Nombre");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_INSTANCE, "Instancia");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_NAME, "Nome");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_INSTANCE, "Instância");
	}
	
	/**
	 * Retrieves the name of a log data hierarchy element, if
	 * set by this extension's name attribute.
	 * 
	...
	/**
	 * Assigns any log data hierarchy element its name, as
	 * defined by this extension's name attribute.
	 * 
	...
	/**
	 * Retrieves the activity instance identifier of an event, 
	 * if set by this extension's instance attribute.
	 * 
	...
	/**
	 * Assigns any event its activity
	 * instance identifier, as defined by this extension's 
	 * instance attribute.
	 * 
	 * @param event Event to assign activity
	 * 	instance identifier to.
	 * @param name The activity instance identifier to be assigned.
	 */
