 ...
 * 
 * These semantic attributes reference concepts, which are represented
 * by event log objects, as unique URIs.
 * 
...
public class XSemanticExtension extends XExtension {
	 ...
	 */
	public static final URI EXTENSION_URI = URI.create("http://code.deckfour.org/xes/semantic.xesext");
	/**
	...
	private XSemanticExtension() {
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_MODELREFERENCE, "Ontology Model Reference");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_MODELREFERENCE, "Ontologie-Modellreferenz");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_MODELREFERENCE, "Référence au Modèle Ontologique");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_MODELREFERENCE, "Referencia de Modelo Ontológico");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_MODELREFERENCE, "Referência de Modelo Ontológico");
	}
	
	/**
	 * Retrieves the list of model references which describe a 
	 * log element (archive, log, trace, event, attribute).
	 * 
	 * @param target Any log element (i.e., archive, log, trace, 
	 * event, or attribute) to be queried.
	 * @return The list of model references, as a list of strings, 
	...
	public List<String> extractModelReferences(XAttributable target) {
		...
		XAttributeLiteral modelReferenceAttribute = (XAttributeLiteral)target.getAttributes().get(KEY_MODELREFERENCE);
	...
	/**
	 * Retrieves the list of model reference URIs which describe a 
	 * log element (archive, log, trace, event, attribute).
	 * 
	 * @param target Any log element (i.e., archive, log, trace, 
	 * event, or attribute) to be queried.
	 * @return The list of model references, as a list of URIs, 
	 * referred to by this element.
	 */
	...
	/**
	 * Assigns to a log element (i.e., archive, log, trace, 
	 * event, or attribute) a list of model references.
	 * 
	 * @param target Any log element (i.e., archive, log, trace, 
	 * event, or attribute) to be assigned references to.
	 * @param modelReferences The list of model references, as a
	 ...
	 * @param target Any log element (i.e., archive, log, trace, 
	 * event, or attribute) to be assigned references to.
	 * @param modelReferenceURIs The list of model references, as a
