 ...
 * It makes it possible to assign to each event a timestamp,
 * describing when the event has occurred.
 * 
...
public class XTimeExtension extends XExtension {
	 ...
	 */
	public static final URI EXTENSION_URI = URI.create("http://code.deckfour.org/xes/time.xesext");
	/**
	...
	private XTimeExtension() {
		...
		ATTR_TIMESTAMP  = factory.createAttributeTimestamp(KEY_TIMESTAMP, 0, this);
		...
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_TIMESTAMP, "Timestamp");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_TIMESTAMP, "Zeitstempel");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_TIMESTAMP, "Horodateur");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_TIMESTAMP, "Timestamp");
		XGlobalAttributeNameMap.instance().registerMapping(
				XGlobalAttributeNameMap.MAPPING_PORTUGUESE, KEY_TIMESTAMP, "Timestamp");
	}
	 ...
	 * @return The timestamp of this event, as a Date object
	 * (may be <code>null</code> if not defined).
	 */
	public Date extractTimestamp(XEvent event) {
		XAttributeTimestamp timestampAttribute = (XAttributeTimestamp)event.getAttributes().get(KEY_TIMESTAMP);
	 ...
	 * @param timestamp Timestamp, as a Date object.
	 */
	 ...
	 * 
	 * @param event Event to be modified.
	 * @param time Timestamp, as a long of milliseconds in UNIX time.
	 */
