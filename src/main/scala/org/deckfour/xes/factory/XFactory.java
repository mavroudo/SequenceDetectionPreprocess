...
/**
 * Factory interface, providing factory methods
 * for creating all element classes of the XES model type
 * hierarchy.
 * 
...
public interface XFactory {
	...
	/**
	 * Returns an URI, pointing to more information about
	 * the specific factory implementation.
	 */
	 ...
	 * Creates a new XES log instance (Factory method).
	 * 
	 * @param attributes The attributes of the log.
	 * @return A new log instance.
	 */
	 ...
	 * Creates a new XES trace instance (Factory method).
	 * 
	 * @param attributes The attributes of the trace.
	 * @return A new trace instance.
	 */
	 ...
	 * @param extension The extension defining the attribute
	 *  (set to <code>null</code>, if the attribute is not associated
	 *  to an extension)
	 ...
	 * 
	 * @param key The key of the attribute.
	 * @param value The value of the attribute, in milliseconds since 01/01/1970 0:00 GMT.
	 * @param extension The extension defining the attribute
	 *  (set to <code>null</code>, if the attribute is not associated
	 *  to an extension)
	 * @return A newly created attribute.
